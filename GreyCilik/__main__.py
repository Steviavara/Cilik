...
buttons = [
    [
        InlineKeyboardButton(
            text="➗ 𝗔𝗗𝗗 𝗚𝗪 𝗗𝗜 𝗚𝗥𝗨𝗣 𝗟𝗨 ➗", url=f"t.me/{bu}?startgroup=new"),
    ],
    [
        InlineKeyboardButton(text="𝗣𝗘𝗥𝗟𝗨 𝗕𝗔𝗡𝗧𝗨𝗔𝗡 ❓", callback_data="help_back"),
        InlineKeyboardButton(
            text="𝗦𝗨𝗣𝗣𝗢𝗥𝗧 💌", url=f"t.me/{SUPPORT_CHAT}"
        ),
    ],
    [
